...
namespace AngularApp1.Server.Migrations
{
    ...
    [Migration("20240909165616_username-index")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AngularApp1.Server.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("AngularApp1.Server.Models.IpAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "9ed45f3e-e82c-49a2-a280-b7c5c2fec7cf",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "f06eaadd-3a57-46ca-b023-02df0d701678",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("AngularApp1.Server.Models.IpAddress", b =>
                {
                    b.HasOne("AngularApp1.Server.Models.Subnet", "Subnet")
            ...
            modelBuilder.Entity("AppUserSubnet", b =>
                {
                    ...
                    b.HasOne("AngularApp1.Server.Models.Subnet", null)
                        .WithMany()
